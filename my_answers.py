...
#         self.activation_function = sigmoid
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        delta_weights_i_h += np.dot((X.reshape(-1,self.input_nodes)).T,hidden_error_term.reshape(-1,self.hidden_nodes))
        # Weight step (hidden to output)
        delta_weights_h_o += np.dot((hidden_outputs.reshape(-1,self.hidden_nodes)).T,output_error_term.reshape(-1,self.output_nodes))
